...
[在 Colab 中运行已验证的 Ettin 单模型闭环](https://colab.research.google.com/github/mingzhuoFUN/jigsaw-agile-community-rules/blob/agent/verified-single-model-colab/notebooks/verified_ettin_colab.ipynb)
